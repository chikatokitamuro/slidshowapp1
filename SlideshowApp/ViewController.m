...
@interface ViewController ()
{
   UIImageView *aImageView;
    UIButton *button1;
    UIButton *button2;
    NSInteger countNumber1;
    NSInteger countNumber2;
}
@end
...
-(void)setupButton{
    ...
    [button1 addTarget:self action:@selector(changeImageUsingString:)
    ...
    [button2 addTarget:self action:@selector(changeImageUsingString:)
      forControlEvents:UIControlEventTouchUpInside];
...
-(void)changeImageUsingString:(id)sender{
    countNumber1++;
    aImageView.image = [UIImage imageNamed:[NSString stringWithFormat:@"cat%ld.png",(long)countNumber1]];
    if (countNumber1==5) {
        countNumber1 = 0;
    }
    
    countNumber2--;
    aImageView.image = [UIImage imageNamed:[NSString stringWithFormat:@"cat%ld−１.png",(long)countNumber2]];
    if (countNumber2==0) {
        countNumber2 = 5;
    }
}
